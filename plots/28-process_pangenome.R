...
wd <- "genespace" # set your working directory where the pangenome_matrix.rds is located
focal_genome <- "Anz_0" # Your focal accession name
...
# How many orthogroups are there? 33852
nrow(pg)
...
table(pg_flags$category)   # accessory: 5691, core: 22477, species_specific: 5684
...
ggplot(freq_data, aes(x = n_present, y = count, fill = type)) +
  ...
  scale_fill_manual(values = c("Genes" = "#0015D2", "Orthogroups" = "#E80E10")) +
  labs(
    x = "Number of genomes",
    y = "Count",
    fill = NULL,
...
print(freq_summary)
#     n_present    label                        Orthogroups     Genes
#             5    Core (all genomes)                 22477    113855
#             4    Shared (4 genomes)                  2041      8804
#             3    Shared (3 genomes)                  1298      4332
#             2    Shared (2 genomes)                  2352      5295
#             1    Species-specific (1 genome)         5684      7528